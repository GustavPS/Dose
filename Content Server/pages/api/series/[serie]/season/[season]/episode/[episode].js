...
export default (req, res) => {
  return new Promise(resolve => {
        ...
        jsonb_agg(DISTINCT jsonb_build_object('path', m.path, 'active', k.active, 'type', k.type)) AS images, i.image_path AS backdrop
        ...
        GROUP BY i.name, i.air_date, i.overview, i.vote_average, i.added_date, j.poster_path, n.id, o.name, i.image_path
